...
public class FavoriteFragment extends Fragment implements RecycleInterface2 {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        search=v.findViewById(R.id.search4);
        database=new NoteDatabase(getContext());
        notes.addAll(database.getFavoriteNotes());
        adapter=new RecycleDeletedNote(notes,this);
        recyclerView = v.findViewById(R.id.rv_notes4);
