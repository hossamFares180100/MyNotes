...
public class LockedFragment extends Fragment implements RecycleInterface2{

    RecyclerView recyclerView;
     ArrayList<Note> notes;
    ArrayList<Note>search_note;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        search=v.findViewById(R.id.search5);
        database=new NoteDatabase(getContext());
        notes.addAll(database.getLockedNotes());
        adapter=new RecycleDeletedNote(notes,this);
        recyclerView = v.findViewById(R.id.rv_notes5);
