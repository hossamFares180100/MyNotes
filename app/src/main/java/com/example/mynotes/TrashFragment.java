...
public class TrashFragment extends Fragment implements RecycleInterface2 {

    RecyclerView recyclerView;
    public static ArrayList<Note> notes,search_note;
    public static RecycleDeletedNote adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        search=v.findViewById(R.id.search2);
        database=new NoteDatabase(getContext());
        notes.addAll(database.getDeletedNotes());
        adapter=new RecycleDeletedNote(notes,this);
        recyclerView = v.findViewById(R.id.rv_trash);
